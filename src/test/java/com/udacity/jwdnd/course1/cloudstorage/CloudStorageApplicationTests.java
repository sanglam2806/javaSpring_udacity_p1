...
class CloudStorageApplicationTests {
     ...
     **/
    private void doMockSignUp(String firstName, String lastName, String userName,
            String password) {
    ...
    public void testRedirection() {
        ...
        Assertions.assertEquals("http://localhost:" + this.port + "/login",
     ...
     * your code to ensure that it meets certain rubric criteria.
     *
     * If this test is failing, please ensure that you are handling uploading
     * large
     * files (>1MB),
